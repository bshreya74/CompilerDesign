...
{	
	...
	public Compiler(InputStream input, OutputStream tokenOutput, OutputStream lexErrOutput, OutputStream derivationOutput, OutputStream synErrOutput, String tablesOut, String semErrOut, String codeData, String codeInstruction, String programName)
	{
		m_lexicalAnalyzer = new LexicalAnalyzer(input, tokenOutput, lexErrOutput, programName);
		m_syntaxAnalyzer = new SyntacticAnalyzer(programName, derivationOutput, synErrOutput, tablesOut, semErrOut, codeData, codeInstruction);
